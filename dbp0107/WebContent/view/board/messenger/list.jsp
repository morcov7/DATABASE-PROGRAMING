...
<table align = "center" width = "70%" class="list">
	...
	<c:forEach var="board" items="${boardList}">
		<tr>
			<td width = "100" align = "center" height = "22">${board.board_no}</td>
			
			<td width = "400" align = "center" height = "22">
				<a class = "list" href="<c:url value='/view/board/messenger/detail'>
						   <c:param name="notice_board_no" value='${board.board_no}'/>
